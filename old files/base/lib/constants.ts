...
export const slashOptions = {
  "3": (slashCommand: SlashCommandBuilder, arg: Argument) =>
  ...
  "4": (slashCommand: SlashCommandBuilder, arg: Argument) =>
  ...
  "5": (slashCommand: SlashCommandBuilder, arg: Argument) =>
  ...
  "6": (slashCommand: SlashCommandBuilder, arg: Argument) =>
  ...
  "7": (slashCommand: SlashCommandBuilder, arg: Argument) =>
  ...
  "8": (slashCommand: SlashCommandBuilder, arg: Argument) =>
  ...
  "10": (slashCommand: SlashCommandBuilder, arg: Argument) =>
